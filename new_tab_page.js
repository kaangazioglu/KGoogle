...
<cr-dialog id="dialog" show-on-attach>
  ...
  <div slot="body">
    <div id="buttons">
      ...
      <cr-button id="emailButton" title="E-posta" on-click="onEmailClick_">
      </cr-button>
    </div>
    <cr-input readonly="readonly" label="Doodle BaÄŸlantÄ±sÄ±" id="url" value="[[url.url]]">
      <cr-icon-button id="copyButton" slot="suffix" title="BaÄŸlantÄ±yÄ± Kopyala" on-click="onCopyClick_">
      </cr-icon-button>
    </cr-input>
  </div>
  ...
  <div id="doodle" title="[[doodle_.description]]">
    <div id="imageDoodle" hidden="[[!imageDoodle_]]" tabindex$="[[imageDoodleTabIndex_]]" on-click="onImageClick_" on-keydown="onImageKeydown_">
      <div id="imageContainer">
        ...
        <cr-button id="shareButton" title="Doodle PaylaÅŸ" on-click="onShareButtonClick_" hidden="[[!imageDoodle_.shareButton]]">
  ...
  <dom-if if="[[lazyRender_]]" on-dom-change="onLazyRendered_">
    <template>
      ...
      <div id="customizeButtonContainer">
        <cr-button id="customizeButton" on-click="onCustomizeClick_" title="Bu sayfayÄ± Ã¶zelleÅŸtir" aria-pressed="[[showCustomize_]]">
          <div id="customizeIcon"></div>
          <div id="customizeText" hidden$="[[showBackgroundImage_]]">
            Chrome&#39;u Ã¶zelleÅŸtir
          </div>
        </cr-button>
      </div>
      <div id="themeAttribution" hidden$="[[!theme_.backgroundImage.attributionUrl]]">
        <div>TemayÄ± oluÅŸturan:</div>
